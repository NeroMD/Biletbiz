    ...
    <div class="container" style="background-image: url(foto/back.jpg);height: 55cm">
        <div class="navbar">
            <ul>
                ...
                <li><a href="companyEvent.php">Company's Events</a> </li>
            </ul>
            <div class="searchbox">
            ...
            <div class="logo">
                <img src="foto/logo.png" alt="Logo" style="width:250px; height:70px;">
            </div>
            <div id="rightMenu" class="sidenav">
                <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
                <a href="companyprofile.html">Profile</a>
                <a class="button" onclick="popup1Toggle();">Logout</a>
            </div>
            <div class="logout">
                <!--user name near user logo on page-->
                <span style="color:#ad5151;margin-right: 10px;font-size: 25px"><?php echo $rowa; ?></span>
