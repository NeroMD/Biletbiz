      ...
      <div class="partpage">
        ...
        <div class="sol">
          <div class="slider">
            <div class="slides">
              ...
              <div class="slide">
                <img src="foto/KenanDoğulu.jpg" alt="">
              </div>
              <div class="slide">
                <img src="foto/ZeynepBastık.jpg" alt="">
              </div>
              <div class="slide">
                <img src="foto/MabelMatiz.jpg" alt="">
              </div>
        ...
        <div class="sol1">
          <div class="calenderlist">
            <h1>Calender</h1>
            <ul>
              <li><a href="#" class="calender">Sıla Konseri</a></li><br>
              <li><a href="#" class="calender">Bkm ÇGHB</a></li><br>
              <li><a href="#" class="calender">TolgShow</a></li><br>
              <li><a href="#" class="calender">Mabel Matiz Konseri</a></li><br>
              <li><a href="#" class="calender">Yasemin Sakallıoğlu Stand-Up</a></li><br>
              <li><a href="#" class="calender">Güldür Güldür</a></li><br>
              <li><a href="#" class="calender">Ölün Bizi Ayırana Dek</a></li><br>
              <li><a href="#" class="calender">İki Bekar</a></li><br>
              <li><a href="#" class="calender">Buray Konseri</a></li><br>
            </ul>
          </div>
        </div>
        <!---cinema-->
